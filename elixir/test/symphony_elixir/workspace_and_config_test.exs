defmodule SymphonyElixir.WorkspaceAndConfigTest do
  ...
  test "config reads defaults for optional settings" do
    ...
    write_workflow_file!(Workflow.workflow_file_path(), claude_command: "claude --model claude-sonnet-4")
    assert Config.settings!().claude.command == "claude --model claude-sonnet-4"
