defmodule SymphonyElixir.Orchestrator do
  ...
  defp integrate_claude_update(running_entry, %{event: event, timestamp: timestamp} = update) do
...

    {
      Map.merge(running_entry, %{
        ...
        claude_pid: claude_pid_from_update(claude_pid, update),
  ...
  defp claude_pid_from_update(_existing, %{claude_pid: pid})
       when is_binary(pid),
       do: pid
  ...
  defp claude_pid_from_update(_existing, %{claude_pid: pid}) when is_list(pid),
    do: to_string(pid)

  defp claude_pid_from_update(existing, _update), do: existing
